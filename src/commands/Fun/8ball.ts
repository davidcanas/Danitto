...
export default class eightBall extends Command {
    ...
    async execute(ctx: CommandContext): Promise<void> {
        ...
        let answer = getRandom([
            ...
            { r: "Parabéns! Você encontrou uma mensagem secreta com 1% de chance de aparecer, Manda print para o dono do bot pois isso é muito raro!", chance: 1 },
        ...
        .setTitle('🔮 8ball')
        .setColor('RANDOM')
        .setDescription(`${ctx.author.mention} fez uma pergunta: \n **Pergunta:** \n ${ctx.args.join(" ")} \n **Resposta:** \n ${answer.r}`)
